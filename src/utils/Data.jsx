...
export const experiences = [
  {
    ...
    desc: "Worked on two cross-platform projects: Power BI Dataset Automation & a Full Stact Web Development project integrating Power BI, Tableau reports. Led the web development project from prototype to live, deployment with added features within 9 months.",
    skills: [
      "React Js",
      "Node Js",
